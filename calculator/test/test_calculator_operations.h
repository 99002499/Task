...
/* Note: Do not edit END */
  ...
  CU_add_test(suite, "primenum2", test_primenum2);
  CU_add_test(suite, "evenorodd1", test_evenorodd1);
   CU_add_test(suite, "evenorodd2", test_evenorodd2);
   CU_add_test(suite, "posneg1", test_posneg1);
  CU_add_test(suite, "posneg2", test_posneg2);
  CU_add_test(suite, "factorial1", test_factorial1);
   CU_add_test(suite, "factorial2", test_factorial2);
   ...
   CU_add_test(suite, "square2", test_square2);
   CU_add_test(suite, "cube1", test_cube1);
  CU_add_test(suite, "cube2", test_cube2);
  CU_add_test(suite, "reverse1", test_reverse1);
  CU_add_test(suite, "reverse2", test_reverse2);
  CU_add_test(suite, "palindrome1", test_palindrome1);
  CU_add_test(suite, "palindrome2", test_palindrome2);
